...
<tiles:insertDefinition name="defaultTemplate">
	<tiles:putAttribute name="body">
			...
			<div class="col-lg-8">
				<div class="ibox">
					<div class="ibox-content">
						<a href="<c:url value='/admin/stock/list'/>" class="btn-link">
							<h2>Quản lý Kho</h2>
						</a>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
							<input type="text" class="form-control" id="stockPosition" name="stockPosition" >
							</div>
						</div>
					</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
								...
								<div class="form-group">
									<label for="name" class="col-sm-2 control-label">Tên</label>
									<div class="col-sm-10">
										<input type="text" class="stockName form-control" id="stockName" name="stockName" >
									</div>
								</div>
								<div class="form-group">
									<label for="name" class="col-sm-2 control-label">Vị Trí</label>
									<div class="col-sm-10">
										<input type="text" class="stockPosition form-control" id="stockPosition" name="stockPosition" >
									</div>
								</div>
					</div>
					<div class="modal-footer">
		...
		<script
			src="<c:url value='/resources/default/js/page/stock.js'/>"></script>
	</tiles:putAttribute>
